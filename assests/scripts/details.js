const keys =
  "ts=1670913383902&apikey=edc9531ea872c74a2855ed93a5903229&hash=bbb581dcf34e4752243b361daa960fb1";
let getCharacterDetails =
...
function print_character(ch_data) {
  ...
  if (data.length != 0) {
    ...
    let thumb_link =
      `${data.thumbnail.path}.${data.thumbnail.extension}`.replace(
        "http",
        "https"
      );
